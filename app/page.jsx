      ...
      >
        {events.length > 0 && (
          <>
            ...
            >
              <span className="bg-ayicc-dark-green h-full absolute left-0 top-0 text-white flex flex-col justify-center px-2 z-50">Events:</span>
      ...
      <section className="py-[2rem] px-[4rem] bg-ayicc-light-green flex flex-col md:flex-row items-center justify-center gap-10 min-h-[50vh]">
        <div className="w-full md:w-2/4 flex flex-col gap-4 text-[#002E5B]">
          ...
          <p>
            ...
            youth-led climate advocacy and initiatives, we participate in these
            activities.
          </p>
        </div>
